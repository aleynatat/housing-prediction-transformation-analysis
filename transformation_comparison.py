...
# ==========================================
# 8. FEATURE TRANSFORMATION (Yeo-Johnson)
# ==========================================
...
# Final Model
final_model = LGBMRegressor(**best_params_lgbm, verbose=-1, random_state=42)
final_model.fit(X_train_transformed_df, y_train_transformed)

y_pred_final_lgbm_trans = final_model.predict(X_test_transformed_df)
y_pred_final_lgbm_original = inverse_boxcox(y_pred_final_lgbm_trans, lambda_y)

print("\n----- Final LightGBM With Hyperparameter + Transformation -----")
print(evaluate_model(y_test, y_pred_final_lgbm_original))
